...
all_data = make_whole_data(target="tetx_coppml")
all_data.shape
...
_, ax = plt.subplots(figsize=(18, 10))
ax = plot(all_p, '--.', label="Predicted", color="silver", logy=True, show=False)
plot(all_t, '.', label="True", logy=True, xlabel="Number of Exmaples", ylabel="tetx (Coppml)", ax=ax)
